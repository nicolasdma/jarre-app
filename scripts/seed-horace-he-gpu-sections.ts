/**
 * Seed script for "Making Deep Learning Go Brrrr From First Principles" sections.
 *
 * Reads sections from scripts/output/p2-horace-he-gpu-resegmented.json
 * and inserts them into resource_sections table.
 *
 * Usage: npx tsx scripts/seed-horace-he-gpu-sections.ts
 */
...
const VALID_CONCEPTS = ['gpu-compute-fundamentals'];
...
async function main() {
  // 1. Read JSON
  const jsonPath = resolve(__dirname, 'output/p2-horace-he-gpu-resegmented.json');
