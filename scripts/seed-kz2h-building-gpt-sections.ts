/**
 * Seed script for kz2h-building-gpt sections.
 *
 * Reads sections from scripts/output/kz2h-building-gpt-sections.json
 * and inserts them into resource_sections table.
 *
 * Usage: npx tsx scripts/seed-kz2h-building-gpt-sections.ts
 */
...
const VALID_CONCEPTS = ['attention-mechanism', 'transformer-architecture'];
...
async function main() {
  // 1. Read JSON
  const jsonPath = resolve(__dirname, 'output/kz2h-building-gpt-sections.json');
