/**
 * Seed script for "How to Train Really Large Models on Many GPUs?" sections.
 *
 * Reads sections from scripts/output/p2-lilian-weng-distributed-resegmented.json
 * and inserts them into resource_sections table.
 *
 * Usage: npx tsx scripts/seed-lilian-weng-distributed-sections.ts
 */
...
const VALID_CONCEPTS = ['distributed-training', 'data-parallelism'];
...
async function main() {
  // 1. Read JSON
  const jsonPath = resolve(__dirname, 'output/p2-lilian-weng-distributed-resegmented.json');
