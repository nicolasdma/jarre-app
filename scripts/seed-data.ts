...
export const resources: SeedResource[] = [
  ...
  },
  {
    ...
    phase: 2,
    description: 'Simpler alternative to RLHF. Shows the constrained reward maximization problem has a closed-form solution. No reward model, no RL needed. Matches or exceeds PPO-based RLHF. Now widely adopted for alignment.',
    estimatedHours: 3,
    sortOrder: 115,
    concepts: ['dpo'],
    prerequisites: ['foundation-models'],
  ...
  // ---------------------------------------------------------------------------
  // PHASE 2: PAPERS - Test-Time Compute & Reasoning Models
  // ---------------------------------------------------------------------------
  {
    id: 'openai-o1-blog',
    ...
    author: 'OpenAI',
    phase: 2,
    description: 'OpenAI\'s introduction to o1 reasoning models. Explains test-time compute scaling: performance improves with more "thinking time". Foundational for understanding the reasoning model paradigm.',
    estimatedHours: 2,
    sortOrder: 120,
  ...
  },
  {
    ...
    author: 'DeepSeek',
    phase: 2,
    description: 'Shows reasoning emerges from pure RL without labeled reasoning data. R1-Zero trained only with RL develops self-reflection, verification, and dynamic strategy adaptation. Matches o1 performance. Open weights available.',
    estimatedHours: 4,
    sortOrder: 125,
  ...
  },
  {
    ...
    phase: 2,
    description: 'Practical guide to test-time compute scaling. Shows how to implement "budget forcing" to control reasoning length. Demonstrates scaling laws for inference compute.',
    estimatedHours: 2,
    sortOrder: 130,
  ...
  // ---------------------------------------------------------------------------
  // PHASE 2: PAPERS - Multimodal (Vision-Language Models)
  // ---------------------------------------------------------------------------
  {
    id: 'clip-paper',
    ...
    phase: 2,
    description: 'Foundation of multimodal AI. Contrastive learning aligns image and text embeddings. Enables zero-shot image classification. Trained on 400M image-text pairs. Vision backbone for most VLMs.',
    estimatedHours: 4,
    sortOrder: 135,
  ...
  },
  {
    ...
    author: 'Liu et al.',
    phase: 2,
    description: 'NeurIPS 2023 Oral. First to use GPT-4 to generate multimodal instruction data. Architecture: CLIP encoder + projection + LLaMA. Shows how to extend LLMs with vision. Open-source alternative to GPT-4V.',
    estimatedHours: 4,
    sortOrder: 140,
  ...
  },
  {
    ...
    author: 'Hussein Nasser',
    phase: 1,
    description: 'Understanding backpressure in distributed systems. Why it matters and how to handle it.',
    estimatedHours: 1,
    sortOrder: 200,
    concepts: ['reliability', 'scalability'],
  },
  {
    ...
    author: 'Hussein Nasser',
    phase: 1,
    description: 'Deep dive into the fundamental trade-off between latency and throughput in distributed systems.',
    estimatedHours: 2,
    sortOrder: 210,
  ...
  },
  {
    ...
    author: 'Hussein Nasser',
    phase: 1,
    description: 'System design fundamentals for engineers. Covers scalability, latency vs throughput, backpressure, and more. No fluff, pure engineering.',
    estimatedHours: 10,
    sortOrder: 220,
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    author: 'OWASP',
    phase: 4,
    description: 'Industry standard for LLM security. Covers: prompt injection, insecure output handling, training data poisoning, model DoS, supply chain risks, sensitive information disclosure, excessive agency. Essential checklist before any LLM deployment.',
    estimatedHours: 3,
    sortOrder: 65,
  ...
  },
  {
    ...
    phase: 4,
    description: 'Practical deep-dive into prompt injection attacks. Direct vs indirect injection. Real examples of data exfiltration, privilege escalation. Why "just filter bad inputs" doesn\'t work. Defense strategies.',
    estimatedHours: 2,
    sortOrder: 68,
  ...
  // ---------------------------------------------------------------------------
  // PHASE 5: Compound AI Systems Architecture
  // ---------------------------------------------------------------------------
  {
    ...
    phase: 5,
    description: 'Seminal blog post on Compound AI Systems. State-of-the-art comes from system design, not just better models. 60% of LLM apps use RAG, 30% use multi-step chains. Introduces DSPy. Must-read for AI architects.',
    estimatedHours: 2,
    sortOrder: 85,
  ...
  },
  {
    ...
    phase: 5,
    description: 'Academic survey on compound AI systems. Blueprint architecture for enterprise. Covers orchestration patterns, failure modes, optimization strategies. Systematic view of the emerging paradigm.',
    estimatedHours: 4,
    sortOrder: 88,
    concepts: ['compound-ai-systems'],
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    phase: 6,
    description: 'ICLR 2024. Framework for programming (not prompting) LLMs. Declarative signatures, automatic prompt optimization. Outperforms hand-crafted prompts by 25-65%. Represents the future of LLM application development.',
    estimatedHours: 4,
    sortOrder: 45,
  ...
  },
  {
    ...
    author: 'Stanford NLP',
    phase: 6,
    description: 'Official DSPy docs. Learn signatures, modules, and teleprompters. Practical examples of building self-optimizing pipelines. Alternative paradigm to prompt engineering.',
    estimatedHours: 4,
    sortOrder: 48,
    concepts: ['dspy-programming'],
